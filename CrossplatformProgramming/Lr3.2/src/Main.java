public class Main {
    public static void main(String[] args) {
        ...
        System.out.printf("Sequence 1 - Negatives: %d, Zeros: %d, Positives: %d%n", result1[0],
                result1[1], result1[2]);
        System.out.printf("Sequence 2 - Negatives: %d, Zeros: %d, Positives: %d%n", result2[0],
                result2[1], result2[2]);
        System.out.println("Hello from Lr3.2");
    }
