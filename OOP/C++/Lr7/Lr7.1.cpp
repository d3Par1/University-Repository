...
// Перевантажений оператор додавання - поелементно складає обидва операнди
...
// Перевантажений оператор віднімання - віднімає всі елементи правого операнда від елементів лівого
array array::operator-(array obj2) {
    array temp;
    for (int i = 0; i < 10; i++) {
        temp.nums[i] = nums[i] - obj2.nums[i];
...
// Перевантажений оператор порівняння - повертає true, якщо всі елементи рівні
