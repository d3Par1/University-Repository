...
/*
ЗАВДАННЯ 6: Позначення елементів як невикористовуваних

Альтернативний підхід до видалення: замість фізичного видалення
позначаємо елементи як "видалені" (name = NULL).
При додаванні нових елементів спочатку шукаємо вільні місця.
*/
...
int main(void) {
    ...
    printf("\n=== ВИСНОВКИ ===\n");
    printf("Переваги ледачого видалення:\n");
    printf("+ Швидкість видалення: O(1)\n");
    printf("+ Швидкість додавання при наявності вільних слотів\n");
    printf("+ Менше операцій з пам'яттю\n");
    printf("+ Добре для частих операцій додавання/видалення\n\n");

    printf("Недоліки:\n");
    printf("- Фрагментація пам'яті\n");
    printf("- Додаткове поле для підрахунку активних елементів\n");
    printf("- Потреба в періодичному компактуванні\n");
    printf("- Ускладнення ітерації (треба перевіряти name != NULL)\n\n");

    printf("Рекомендації:\n");
    printf("- Використовуйте при частих операціях додавання/видалення\n");
    printf("- Додайте автоматичне компактування при високій фрагментації\n");
    printf("- Надайте функцію для ручного компактування\n");
    printf("- Приховайте деталі реалізації за API\n");
