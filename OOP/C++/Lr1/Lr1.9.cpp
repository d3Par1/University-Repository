...
/*
ЗАВДАННЯ 9: Додаткові операції зі списком
- копіювання
- злиття
- розбиття
- вставка перед конкретним елементом
- вставка після конкретного елементу
*/
...
int main(void) {
    ...
    printf("\n=== ЗАГАЛЬНІ ВИСНОВКИ ===\n");
    printf("Реалізовані операції:\n");
    printf("1. Копіювання - створює незалежну копію списку\n");
    printf("2. Злиття - об'єднує два списки в один\n");
    printf("3. Розбиття - ділить список на дві частини\n");
    printf("4. Вставка після - додає елемент після заданого\n");
    printf("5. Вставка перед - додає елемент перед заданим\n\n");

    printf("Складність операцій:\n");
    printf("• Копіювання: O(n)\n");
    printf("• Злиття: O(n) для знаходження кінця першого списку\n");
    printf("• Розбиття: O(n) для знаходження точки розбиття\n");
    printf("• Вставки: O(n) для пошуку + O(1) для вставки\n\n");

    printf("Особливості реалізації:\n");
    printf("• Вставка перед першим елементом змінює голову списку\n");
    printf("• Злиття не копіює елементи, а перез'єднує вказівники\n");
    printf("• Копіювання зберігає оригінальний порядок елементів\n");
    printf("• Розбиття створює два незалежні списки\n");
