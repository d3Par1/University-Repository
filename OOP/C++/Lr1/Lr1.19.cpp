...
/*
ЗАВДАННЯ 19: Тестування хеш-функції на різних типах даних

Перевіряємо як хеш-функція працює з:
- Короткими рядками
- Довгими рядками
- Рядками однакової довжини з невеликими відмінностями
- Різними значеннями MULTIPLIER (31-37)
*/
...
int main(void) {
    ...
    printf("\nЧИ ДОБРЕ ХЕШ-ФУНКЦІЇ КОДУЮТЬ КОРОТКІ РЯДКИ, А ДОВГІ?\n");
    printf("• ДОВГІ рядки кодуються КРАЩЕ ніж короткі\n");
    printf("• Більше символів → більше ентропії → кращий розподіл\n");
    printf("• Короткі рядки мають обмежену кількість варіацій\n\n");

    printf("ЩО МОЖЕТЕ СКАЗАТИ ПРО РЯДКИ ОДНАКОВОЇ ДОВЖИНИ?\n");
    printf("• З невеликими відмінностями можуть давати колізії\n");
    printf("• Критично важливі позиції символів, що відрізняються\n");
    printf("• Довші рядки дають більше можливостей для розрізнення\n\n");

    printf("MULTIPLIER ВІД 31 ДО 37 - ЯКИЙ КРАЩИЙ?\n");
    printf("• 31 та 33 показали найкращі результати\n");
    printf("• Парні числа (32, 34, 36) гірші\n");
    printf("• 37 також дає добрі результати\n");
    printf("• Рекомендація: використовуйте 31 або 33\n\n");

    printf("=== ЗАГАЛЬНИЙ ВИСНОВОК ===\n");
    printf("Хеш-функція MULTIPLIER * h + c є:\n");
    printf("• Простою та ефективною\n");
    printf("• Добре працює з довгими рядками\n");
    printf("• Потребує обережності з короткими/подібними рядками\n");
    printf("• Підходить для більшості практичних застосувань\n");
    printf("• Легко налаштовується через зміну MULTIPLIER\n");
